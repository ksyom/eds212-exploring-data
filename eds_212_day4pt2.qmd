...
in Quarto:
putting "#| warning in the opening code chunk: false" in your opening code chunk immediately below "{R}" makes it refrain from printing the warnings through whole document
putting "#| echo in the opening code chunk: false" in your opening code chunk prevents it from printing the code through whole document
